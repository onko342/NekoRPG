...
[35, "Domain", "#c677dd",function(enemy){return "This enemy understands the art of projecting power outward.<br>Each time the enemy is attacked, it deals an additional <span style='color:#87CEFA'>" + (enemy.spec_value[35]) + "</span> domain damage. This damage is mitigated 1:1 by agility."}],
...
[40, "Light-Chasing", "#ecff17", "Light element insight. This enemy is as fast as a beam of light.<br>The enemy first launches a 3-hit <span style='color:#87CEFA'>50x damage</span> <span style='color:#FFFF00'>guaranteed hit</span>."],
[41, "Summon", "#f5deb3", "The embodiment of social creatures working together. When the enemy spawns, 3 extra [Purple Rust Golem] spawn."],
